...
class AppearanceTabWidget(SettingsFormWidget):
    def __init__(self, parent):
        ...
        # Layout
        self._addRow("Default Tab", self.DefaultTabComboBox)
        self._addRow("Sync Library & Downloads Pages", self.SyncLibraryAndDownloadsPages)
        self._addRow("Default Library Page", self.DefaultLibraryPageComboBox)
        self._addRow("Default Downloads Page", self.DefaultDownloadsPageComboBox)
        self._addRow("When New Builds Are Available", self.EnableNewBuildsNotifications)
        self._addRow("When Downloading Is Finished", self.EnableDownloadNotifications)
